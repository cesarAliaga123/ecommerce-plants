        ...
        <div class="flex items-center justify-center h-full bg-black bg-opacity-50">
            <div class="bg-teal-300 bg-opacity-80 rounded-lg shadow-lg p-8 w-full max-w-md my-24">
                ...
                <form action="#" method="POST">
                    ...
                    <!-- Nivel de usuario (Combo box) -->
                    <div class="mb-4">
                        <label for="user_level" class="block text-teal-100 text-lg font-bold mb-2">Nivel de
                            Usuario</label>
                        <select id="user_level" name="user_level"
                            class="w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-teal-500"
                            required>
                            <option value="2">Usuario</option> <!-- ID 2 para usuarios regulares -->
                            <option value="1">Administrador</option> <!-- ID 1 para administradores -->
                        </select>
                    </div>
                    ...
                    <div class="mb-4">
                        <button type="submit"
                            class="w-full bg-teal-500 text-white font-bold py-2 px-4 rounded-md hover:bg-teal-600 transition duration-300">Registrarse</button>
                    </div>

                    <!-- Enlaces adicionales -->
                    <div class="text-center">
                        <p class="mt-2 text-sm">¿Ya tienes una cuenta? <a href="/login"
                                class="text-teal-600 hover:underline">Inicia Sesión</a></p>
